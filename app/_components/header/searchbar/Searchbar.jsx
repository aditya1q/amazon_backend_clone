    ...
    return (
        <div className="w-96 xs:w-auto h-9 flex items-center lg:flex-1 ">
            ...
            <div className="relative inline-flex">
                ...
                {showDropdown && (
                    <div className="scrollbar absolute w-32 h-52 overflow-hidden overflow-y-auto text-[13px] mt-12 text-black bg-white border border-gray-300 rounded-lg shadow">
                        {options.map((option) => (
                            <a
                                key={option.value}
                                href="#"
                                className={`block px-3 py-1 ${selectedOption === option.value ? 'bg-gray-100' : 'hover:bg-blue-500'
                                    }`}
